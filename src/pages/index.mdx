...
The Catalyst series of themes and starters for [GatsbyJS](https://www.gatsbyjs.org/) were designed to provide an opinoinated set of progressive themes and starters that can be used to accelerate the development workflow. The guiding philosophy is to build websites smarter, faster, and easier.
